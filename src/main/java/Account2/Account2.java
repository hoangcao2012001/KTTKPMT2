...
public class Account2 extends JFrame {
	 ...
	 * Create the frame.
	 */
	public Account2() throws Exception{
		
		setTitle("Account2");
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(150, 150, 600, 531);
		...
		//setup jms
				...
				=(Destination) ctx.lookup("dynamicTopics/hoangcao");
				Destination destination1
				=(Destination) ctx.lookup("dynamicTopics/hoangcao2");
				//tạo connection
				...
				//tạo consumer , MessageConsumer là đọc tin nhắn
				//MessageListener  lắng nghe
